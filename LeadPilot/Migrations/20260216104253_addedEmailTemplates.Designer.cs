...
namespace LeadPilot.Migrations
{
    ...
    [Migration("20260216104253_addedEmailTemplates")]
            ...
            modelBuilder.Entity("LeadPilot.Models.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            Active = true,
                            Body = "Hi@ContactName,<br/><br/>Just following up on my earlier note.< br />< br />If improving internal workflows or operational efficiency is on your roadmap, I’d be happy to explore whether there’s a good fit.<br/><br/>Best regards,<br/>Krunal Pagdar<br/>Full-Stack Developer (.NET | Azure)",
                            EmailTypeId = 2,
                            Name = "FollowUp",
